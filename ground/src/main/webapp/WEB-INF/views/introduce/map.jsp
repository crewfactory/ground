...
<body>
	...
	<div class="container-fluid intro-banner-map-container">
		<div class="row sub-row pad-top-140">
			<div class="col-md-12">
				<h1 class="font-white">학원위치조회</h1>
				<div class="my-3">
					<p class="font-white font-14">
						강남캠퍼스(본관) : 서울특별시 강남구 논현동 18-4 성일빌딩 1~2F<br>
						강남캠퍼스(2관) : 서울특별시 강남구 논현동 17-5 극동빌딩 7F<br>
						인천캠퍼스 : 인천광역시 부평구 경원대로 1382 대한빌딩 5F<br>
					</p>
				</div>
				<div class="row">
					<button class="btn btn-danger mb-2 mx-1 font-white font-16" onclick="fnMove('1')">강남캠퍼스본관</button>
					<button class="btn btn-danger mb-2 mx-1 font-white font-16" onclick="fnMove('2')">강남캠퍼스별관</button>
					<button class="btn btn-danger mb-2 mx-1 font-white font-16" onclick="fnMove('3')">인천캠퍼스</button>
				</div>
			</div>
		</div>
	</div>
