                    ...
                    <div class="form-group">
                      ...
                      <label for="userauth">소속팀</label>
                        <select class="form-control mr-2" name="team" id="team">
                          ...
                          <option value="goone" <c:if test="${result.team eq 'goone'}">selected</c:if>>항운1팀</option>
                          <option value="gotwo" <c:if test="${result.team eq 'gotwo'}">selected</c:if>>항운2팀</option>
