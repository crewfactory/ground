...
<body>
   ...
   <div style="text-align: center;">
		<a href="/crewpeople/review.do"><img src="/img/d5_02.png" alt="합격률" id="mobile-100-percent" class="mobile-show"></a>
   </div>
	<div style="text-align: center;">
   ...
   <div style="text-align: center;">
		<a href="/crewpeople/review.do"><img src="/img/d5_02_02.png" alt="합격률" id="mobile-100-percent" class="mobile-hidden" style="width:100%;"></a>
   </div>
	<div style="text-align: center;">
