	...
	<div class="container-fluid edu-banner-ev-main-container">
		<div class="row sub-row py-5">
			<div class="py-5" style="margin: 0 auto; text-align: center;">
				<p class="font-black font-40-m font-bold my-2">
					<span style="color: #fc229c">EVENT</span> STORY</p>
	...
	<div class="container-fluid edu-banner-ev-con-1">
		<div class="row sub-row">
			...
			<div class="col-12 text-center" id="mobile-100-percent">
				...
				<a href="/counsel/online.do"><button class="btn btn-primary" style="width: 100%;">빠른상담 +</button></a></div>
				<div class="col-6 off-hide main-pro-category py-5 px-1">
				<a href="https://pf.kakao.com/_QWAEl"><button class="btn btn-primary" style="width: 100%;">카톡상담 +</button></a></div>
			</div>
			</div>
			</div>
			<div class="line-1-gray my-2" style="width: 100%; margin: 0 auto;"></div>
		...
		<div class="row sub-row">
			<div class="col-12">
				...
				<p class="font-light font-24-m font-white" style="line-height:1.5em;">친구와 있을때와 같은 편한 분위기속의 면접이 아닌 실제 면접장처럼 떨리는 곳,  긴장되는 곳에서 잘해야 하는 항공과 입시 면접 , 떨릴수록 진짜 원래의 모습이 나오므로 그 부분에 익숙해지고 숙달하며 성장하는 기회</p></div>
	...
	<div class="container-fluid edu-banner-ev-con-1">
		...
		<div class="row sub-row">
			<div class="col-12">
				...
				<p class="font-light font-24-m font-white" style="line-height:1.5em;">내가 가고 싶은 또는 생각 했던 대학에 대한 정보가 부족하나요? 실제 해당 대학 합격생들과 재학생간의 받았던 질문이나 면접 팁 등을 공유함으로서 보다 자신감을 얻고, 면접 준비에 있어 한단계 더 도약할 수 있는 시간</p></div>
		...
		<div class="row sub-row">
			<div class="col-12 py-5">
				<div class="col-6 text-right py-5 px-5 mobile-100-percent">
				<p class="font-light font-40-m font-lightblack">틀림없는 선택, 틀림없는 결과</p>
				<p class="font-light font-bold font-40-m"><span style="color:#8b9fc3">결과로 증명하다</span></p>
				</div>
				<div class="col-6 text-left mobile-100-percent py-5">
				<p class="font-light font-20-m font-gray" style="line-height:1.5em;">인하공전 항공운항과 - [면접만접자 배출]</p>
				<p class="font-light font-20-m font-gray" style="line-height:1.5em;">한서대 항공관광학과 및 주요대학 - [장학생 배출]</p>
				<p class="font-light font-20-m font-gray" style="line-height:1.5em;">수원과학대 항공관광과 - [수석 합격생 배출]</p>
				<p class="font-light font-20-m font-gray" style="line-height:1.5em;">재능대 항공운항서비스과 - [수석 / 차석 합격생 배출]</p>
				<p class="font-light font-20-m font-gray" style="line-height:1.5em;">두원공과대 항공서비스과 - [전액 특별 장학생 배출]</p>
				<p class="font-light font-20-m font-gray" style="line-height:1.5em;">호원대 항공서비스과 - [장학금 특별 장학생 배출]</p></div>
			</div>
		</div>
		...
		<div class="col-12 text-center px-5"><img src="/img/main-eventpa-img.jpg" id="mobile-100-percent"></div>
		<div class="col-12 py-5 pd-5"></div>
	</div>
	</div>
